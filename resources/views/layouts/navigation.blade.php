<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
    <div class="container px-3">
        ...
        <a class="navbar-brand d-flex align-items-center fw-bold text-primary" href="{{ route('dashboard') }}"
            wire:navigate>
            <img src="https://cdn-icons-png.flaticon.com/512/3771/3771391.png" alt="Logo" width="30" height="30"
                class="me-2">
            MyDrive
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                @foreach ($navItems as [$label, $route])
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs($route) ? 'active fw-bold text-primary' : '' }}"
                            href="{{ route($route) }}" wire:navigate>{{ $label }}</a>
                    </li>
                @endforeach
            </ul>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    <li><a class="dropdown-item" href="{{ route('profile.edit') }}" wire:navigate>Profile</a></li>
                    <li>
